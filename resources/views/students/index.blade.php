@extends('layouts.app')
@section('title', 'eParcel Sys - Dashboard FARIS AIMAN HIDAYAT BIN KAMARUDDIN')
@section('content')
    <div id="Content">
                    ...
                    <div class="col-lg-6">
                        <div class="card" >
                            <div class="card-body text-center">
                                ...
                                <h1 class="card-subtitle mb-2 text-warning">3</h1>
                    ...
                    <div class="col-lg-6">
                        <div class="card" >
                            <div class="card-body text-center">
                                ...
                                <h1 class="card-subtitle mb-2 text-success">12</h1>
